...
export default class NUAttribute extends NUObject {
    ...
    constructor(obj) {
        ...
        this.defineProperties({
            ...
            isEditable: !(!!obj.isCreateOnly || !!obj.isReadOnly || !!obj.isTransient),
    ...
    */
    validate(entity, attrObj, formValues) {
        ...
        if (attrObj) {
            const attrValue =  entity && entity[attrObj.name] !== undefined && entity[attrObj.name] !== null ? entity[attrObj.name] : (formValues && formValues[attrObj.name]);
